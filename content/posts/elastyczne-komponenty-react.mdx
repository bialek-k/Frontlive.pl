...
- **Nieprzewidywalność**
  ...
  Obecnie nie ma dobrego sposobu na wskazanie Reactowi, żeby przyjmował tylko określone dzieci. Co prawda możemy zastosować kilka "brudnych szcztuczek", o których pisałem w artykule [React Children & TypeScript - jak to ogarnąć?](https://frontlive.pl/blog/react-children-i-typescript), ale czy jest to warte naszej pracy?
